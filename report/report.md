...
1. Есть банк, предоставляющий свои услуги обычным клиентам. Он обладает следующими свойствами:
	1. Конкретные услуги - выдача кредитов под процент и предоставление банковких счетов и карт, с возможностью хранения денег.
...
#### Создание собственно базы данных



#### Создание пользовательских форм для работы
